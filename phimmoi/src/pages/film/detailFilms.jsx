                            ...
                            <div className="row">
                                <div className="col-lg-3">
                                    <div className="anime__details__pic" data-setbg="img/anime/details-pic.jpg">
                                        ...
                                        <div className="view">
                                            <i className="fa fa-eye"> Xem: {film?.viewed}</i>
                                        </div>
                                    </div>
                                            ...
                                            <div className="row-detail">
                                                <div className="col-lg-6">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <span>Diễn Viên:</span> {film?.actors}
                                                        </li>
                                                        <li>
                                                            <span>Trạng thái:</span> {film?.status}
                                                        </li>
                                                        <li>
                                                            <span>Đạo diễn:</span> {film?.director}
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div className="col-lg-6">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <span>Số tập:</span> {film?.totalChap}
                                                        </li>
                                                        <li>
                                                            <span>Thời lượng phim:</span> {film?.movieDuration } phút
                                                        </li>
                                                        <li>
                                                            <span>Lượt xem:</span> {film?.viewed}
                                                        </li>
                                                        <li>
                                                            <span>Đánh giá:</span>{`${(film?.totalPoints/film?.countRating).toFixed(1)} điểm / ${film?.countRating} lượt`} 
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
